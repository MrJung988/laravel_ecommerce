            ...
            <!-- <div class="row"> -->
                ...
                <div class="col-md-6 header-right-middle">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link navLink" href="{{ route('home_page') }}">Home</a>
                        </li>
                        <!-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link navLink" href="{{ route('addToCart') }}">My Cart</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navLink" href="#">Track My Order</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navLink" href="#contact_us">Contact Us</a>
                        </li>
                    </ul>
                </div>
