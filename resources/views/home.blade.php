  ...
  <div class="container">
    ...
    <div class="cards d-flex flex-wrap">
      @foreach($productDetails as $productDetail)
        <div class="card">
          <img src="{{ asset('/image/products/'. $productDetail->product_image) }}" class="card-img-top" alt="" style="cursor:pointer;"><hr>
          <div class="card-body">
            ...
            <a href="#"><button class="btn btn-primary" style="width: 100%;">Add to cart</button></a>
