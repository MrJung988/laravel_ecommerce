...
Route::group(['prefix' => 'admin'], function() {
	...
	Route::group(['middleware' => 'admin.auth'], function(){
		...
		Route::get('/user-feedback', [ContactUsController::class, 'index'])->name('admin.userFeedback');
...
Route::group(['middleware' => 'guest'], function(){
	...
	Route::post('/login', [UserController::class, 'loginUser'])->name('user_login');
	
	Route::get('/signup', [UserController::class, 'signup'])->name('userSignup');
	Route::post('/signup', [UserController::class, 'store'])->name('user_signup');
});


Route::group(['middleware' => 'auth'], function(){
	Route::post('/contact-form', [ContactUsController::class, 'submitContactUsForm'])->name('submitContactUsForm');
	
	Route::get('/add-to-cart', [UserController::class, 'addToCart'])->name('addToCart');
